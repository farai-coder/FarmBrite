...
export const SchedulePage = () => {
  ...
  const handleEditEvent = () => {
    if (selectedEvent) {
      ...
      setFormData({
        title: selectedEvent.title.replace(
  ...
  const handleSubmit = () => {
    ...
    let startDateTime = moment(formData.startDate)
      ...
      .toDate();
    let endDateTime = moment(formData.endDate)
      .hour(endTime.hour)
    ...
    // Handle repeats
    if (formData.repeats !== "Does not repeat") {
      let repeatCount = 5; // Generate next 5 occurrences
      let unit =
        formData.repeats === "Daily"
          ? "days"
      ...
      for (let i = 1; i <= repeatCount; i++) {
        const newStart = moment(startDateTime).add(i, unit).toDate();
        const newEnd = moment(endDateTime).add(i, unit).toDate();
          ...
          <div className="p-6">
            ...
            <div className="space-y-3">
              ...
              <div className="mt-4 pt-4 border-t text-xs text-gray-500">
                <p>
                  Created Sep. 23, 2025 | Created by {selectedEvent.assignedTo}
                </p>
                ...
                <div className="space-y-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="flex space-x-2">
                        ...
                        <select
                          ...
                          onChange={(e) =>
                            handleInputChange("endMinute", e.target.value)
                          }
                          className="w-20 px-2 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                        >
                          {minuteOptions.map((minute) => (
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        handleInputChange("repeats", e.target.value)
                      }
                      className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                    >
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        handleInputChange("associatedTo", e.target.value)
                      }
        ...
        <div className="p-4">
          <div className="flex space-x-2 mb-4">
            <button
              ...
              className={`px-4 py-2 rounded-md ${
                !listView && currentView === Views.DAY
                  ? "bg-green-100 text-green-700"
                  : "text-gray-600 hover:bg-gray-100"
              }`}
            >
            ...
            <button
              ...
              className={`px-4 py-2 rounded-md ${
                !listView && currentView === Views.WEEK
                  ? "bg-green-100 text-green-700"
                  : "text-gray-600 hover:bg-gray-100"
              }`}
            >
            ...
            <button
              ...
              className={`px-4 py-2 rounded-md ${
                !listView && currentView === Views.MONTH
                  ? "bg-green-100 text-green-700"
                  : "text-gray-600 hover:bg-gray-100"
              }`}
            >
